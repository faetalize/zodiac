import { Message, GeneratedImage, type MessageDebugInfo } from "../../types/Message";
...
export const messageElement = async (
    ...
    //model message
        ...
        if (isNarrator) {
            ...
            const narratorFooterMarkup = originModelLabel || debugButtonMarkup
