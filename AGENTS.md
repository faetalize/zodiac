...
|---------|----------------|------------------|-----------|-------|
| **Chat Management** |
| Chat CRUD | [Chats.service.ts](src/services/Chats.service.ts), [Chat.ts](src/models/Chat.ts) | — | ✓ | IndexedDB storage with incremental message loading |
...
| **Group Chats** |
| RPG group chat mode | [GroupChat.service.ts](src/services/GroupChat.service.ts), [Message.service.ts](src/services/Message.service.ts#L1700) | ✓ | ✓ | Turn-based multi-persona conversations with turn order |
| Narrator feature | [Message.service.ts](src/services/Message.service.ts#L1800) | ✓ | — | AI-generated plot events/interruptions in RPG mode |
| Group dynamic mode | [Chat.ts](src/models/Chat.ts#L5) | — | — | Planned (not implemented) |
| **AI & Responses** |
...
| Premium endpoint fallback | [Message.service.ts](src/services/Message.service.ts#L425), [PremiumEndpointResponseProcessor.service.ts](src/services/PremiumEndpointResponseProcessor.service.ts) | ✓ | — | Server-side API key for unrestricted access |
| Response streaming | [Message.service.ts](src/services/Message.service.ts#L580-L640) | ✓ | ✓ | Real-time token-by-token response rendering |
| Response interruption | [Message.service.ts](src/services/Message.service.ts#L100), [Message.ts](src/models/Message.ts#L25) | ✓ | ✓ | User can abort mid-generation, partial content saved |
| Thinking/reasoning (CoT) | [Message.ts](src/models/Message.ts#L21), [GeminiResponseProcessor.service.ts](src/services/GeminiResponseProcessor.service.ts) | ✓ | ✓ | Chain-of-thought in collapsible section, configurable budget |
...
| **Image Generation** |
| Image generation (diffusion) | [Message.service.ts](src/services/Message.service.ts#L2100), [ImageButton.component.ts](src/components/static/ImageButton.component.ts) | ✓ | — | Dedicated image models (Imagen-4.0) via premium endpoint |
| Image editing (diffusion) | [ImageEditButton.component.ts](src/components/static/ImageEditButton.component.ts), [Message.service.ts](src/services/Message.service.ts#L2200) | ✓ | — | Inpaint/outpaint with Qwen-VL editing models |
| Image gen by Gemini multimodal | [Message.service.ts](src/services/Message.service.ts#L2300) | ✓ | ✓ | Nano Banana multimodal LLMs (image gen as part of chat) |
...
| **Personas** |
| Persona CRUD | [Personality.service.ts](src/services/Personality.service.ts), [Personality.ts](src/models/Personality.ts) | — | ✓ | Local UUID-based with marketplace sync support |
...
| Persona categories & tags | [Personality.ts](src/models/Personality.ts#L14-L24) | — | ✓ | Marketplace organization; syncedFrom tracks origin |
...
| **Attachments** |
| File attachments | [AttachButton.component.ts](src/components/static/AttachButton.component.ts), [Message.ts](src/models/Message.ts#L14) | ✓ | ✓ | Up to 6 files, 10MB total (PDFs, text, images) |
...
| Light/dark mode | [Theme.service.ts](src/services/Theme.service.ts#L60) | — | ✓ | Manual override or OS preference sync |
...
| Password recovery | [PasswordReset.component.ts](src/components/static/PasswordReset.component.ts), [Supabase.service.ts](src/services/Supabase.service.ts#L25) | — | ✓ | Email-based password reset flow |
| Email update | [EmailUpdate.component.ts](src/components/static/EmailUpdate.component.ts) | — | ✓ | Change primary email address |
| Session management | [Supabase.service.ts](src/services/Supabase.service.ts#L31) | — | ✓ | Real-time auth state tracking with CustomEvents |
| **Monetization** |
...
| Manage subscription | [Supabase.service.ts](src/services/Supabase.service.ts#L380) | ✓ | — | Stripe customer portal access |
| **Data & Import** |
...
### Data Models
- `Chat` / `DbChat` - Conversations with messages and optional group chat config
- `Message` - User/model messages with attachments, generated images, thinking traces
- `Personality` / `DbPersonality` - Customizable AI personas with tone settings
...
1. Extend `Message` interface in [src/models/Message.ts](src/models/Message.ts)
